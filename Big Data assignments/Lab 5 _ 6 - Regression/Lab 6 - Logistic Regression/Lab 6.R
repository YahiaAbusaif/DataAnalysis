...
# A1) (Price, Income), (Price, Age)

#(Q2) Are there any highly correlated variables in this dataset?
# No, Age, Income are correlated but not highly correlated.
...
# Because it is a categorical variable with (n=3) values
# So we use (n-1) 2 dummy variables instead.
...
# A7) The probability decreases as the price goes up which makes sense.
# The more expensive the item is the less likely we buy it.
...
# A8) The probability increases as the age goes up.
# The older we get we become more capable to buy the item I think.
...
# A9) The probability increases as the income goes up.
# The more money we have the more likely we buy the item.
